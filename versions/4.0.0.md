...
<a name="oasDocumentType"></a>openapi-document | `string` | **REQUIRED**. This string MUST be the [`OAS Fragment`] value identifying the overlay document
<a name="oasOverlayDescription"></a>description | string | Description of the fragment usage
...
---|:---:|---
<a name="fragmentVersion"></a>openapi | `string` | **REQUIRED**. This string MUST be the [semantic version number](https://semver.org/spec/v2.0.0.html) of the [OpenAPI Specification version](#versions) that the OpenAPI document uses. The `openapi` field SHOULD be used by tooling specifications and clients to interpret the OpenAPI document. This is *not* related to the API [`info.version`](#infoVersion) string
<a name="oasDocumentType"></a>openapi-document | `string` | **REQUIRED**. This string MUST be the [`OAS Library`] value identifying the overlay document
<a name="oasOverlayDescription"></a>description | string | Description of the fragment usage
...
openapi: 4.0.0
openapi-document: OAS Fragment
description: Library with some shared documents
components:
  schemas:
    User:
      type: object
