...
Merge objects is a very limited way to define templating of JSON/YAML data structures. It allows to merge object definition
...
Definition:  Every element of JSON structure which contains `$merge` key is a subject to the merge operation. 
