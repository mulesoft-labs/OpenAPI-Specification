...
Simple Macro is a very limited way to define templating JSON/YAML data structures:
...
b) Launch the following algorithm on the cloned data structure:
...
Merging is performed by the same algorithm as merging of overlays and extensions:

https://github.com/mulesoft-labs/OpenAPI-Specification/pull/3/files#diff-d1455f6edb807e38d88298c2361ec1e3R3644
